      ...
      <div className="max-w-4xl mx-auto">
        ...
        {!engine.results && !engine.showRoleComparison ? (
          ...
          <ResultsView
            ...
            whatIfBudgetAmount={engine.whatIfBudgetAmount}
            setWhatIfBudgetAmount={engine.setWhatIfBudgetAmount}
            whatIfLanguages={engine.whatIfLanguages}
            setWhatIfLanguages={engine.setWhatIfLanguages}
            whatIfTravel={engine.whatIfTravel}
            setWhatIfTravel={engine.setWhatIfTravel}
            whatIfDiscretion={engine.whatIfDiscretion}
            setWhatIfDiscretion={engine.setWhatIfDiscretion}
            whatIfCerts={engine.whatIfCerts}
            setWhatIfCerts={engine.setWhatIfCerts}
