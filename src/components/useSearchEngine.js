...
=== RETURN THIS JSON ===
{
  ...
  "whatsNext": {
    ...
    "sourcingStrategy": "1–2 sentences: how WE (Talent Gurus) source THIS role directly — our referral networks, our outreach, our candidate database. Never mention agencies, partnerships, or third-party firms — WE are the search firm. Reference specific associations or professional communities relevant to ${displayTitle}.${formData.discretionLevel !== 'standard' ? ' Factor the ' + (discOption?.label || formData.discretionLevel) + ' discretion level into channel selection — which channels are off-limits, which require extra vetting.' : ''}",
